document.addEventListener("DOMContentLoaded", function () {
  ...
  const templePhotos = document.getElementById("temple-photos");
  ...
  function createTempleCard(temple) {
      ...
      figcaption.innerHTML = `
          ...
          Area: ${temple.area} square feet
      `;

      card.appendChild(image);
      card.appendChild(figcaption);
      templePhotos.appendChild(card);
  }

  function clearTempleCards() {
      templePhotos.innerHTML = "";
  }

  function displayTempleCards(filter) {
      clearTempleCards();
      if (filter === "home") {
  ...
  fetch("scripts/temples.js")
      .then(response => response.headers.get("last-modified"))
      .then(date => {
          document.getElementById("lastModified").textContent = "Last modified: " + new Date(date).toLocaleString();
      });
});
